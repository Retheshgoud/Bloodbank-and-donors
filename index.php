...
<?php include('includes/slider.php');?>
    ...
    <div class="container">
        ...
        <h1 class="my-4">Welcome to Blood bank and donors,Meet Blood Donors & Donate Blood</h1>
		<br>
		<img src="images/2679190.png" <span> <h2>The Need To Donate Blood</h2>
        <p1>The reason to donate is simple…it helps save lives. In fact, every two seconds of every day, someone needs blood. Since blood cannot be manufactured outside the body and has a limited shelf life, the supply must constantly be replenished by generous blood donors.</p1>
<br>
<br>
<h3>TIPS FOR BLOOD DONATION</h3>
<ul>
